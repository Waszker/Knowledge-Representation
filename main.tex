...
\begin{minipage}[t]{0.5\textwidth}
$Res_{0}(\textsc{Code},Fred,\sigma_{0}) = \{\sigma_{1},\sigma_{3}\}$\\
$New(\textsc{Code},Fred,\sigma_{0},\sigma_{1}) = \{cc\}$\\
$New(\textsc{Code},Fred,\sigma_{0},\sigma_{3}) = \{cm,cc\}$\\
$Res^{-}(\textsc{Code},Fred,\sigma_{0}) = \{\sigma_{1}\}$\\
$Res_{0}^{+}(\textsc{Code},Fred,\sigma_{0}) = \emptyset$\\\
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{graphProgrammers}
\caption{Graf zależności - Programiści Fred i Bill}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.6]{graphalice}
\caption{Graf zależności - Alicja w krainie czarów}
\end{figure}
