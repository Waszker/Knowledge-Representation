...
\item Q2 - Czy wykonanie podanego programu działań z dowolnego stanu spełniającego warunek $\pi$ prowadzi do stanu z którego osiągalny jest (zawsze/kiedykolwiek/typowo) stan spełniający warunek celu $\gamma$ ?\\
